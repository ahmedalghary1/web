...
class Command(BaseCommand):
    ...
    def seed_checklists(self):
        ...
        std_tpl, _ = ChecklistTemplate.objects.get_or_create(code="STANDARD", defaults={"name": "قائمة الصيانة الدورية لماكينات الحقن والمكابس", "version": 1, "is_active": True})
        ...
        spr_tpl, _ = ChecklistTemplate.objects.get_or_create(code="SPRING", defaults={"name": "قائمة الصيانة الدورية لماكينات النفخ", "version": 1, "is_active": True})
